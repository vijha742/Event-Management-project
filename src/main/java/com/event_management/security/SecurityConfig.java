    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(authorize -> authorize
                .requestMatchers("/oauth2/**", "/login", "/", "/api/session/validate").permitAll()
            ...
            .oauth2Login(oauth2 -> oauth2
                ...
                .successHandler((request, response, authentication) -> {
                    ...
                    String sessionToken = generateSessionToken(authentication);
                    Cookie sessionCookie = new Cookie("SESSION-TOKEN", sessionToken);
                    sessionCookie.setHttpOnly(true);
                    sessionCookie.setSecure(true); // For HTTPS environments
